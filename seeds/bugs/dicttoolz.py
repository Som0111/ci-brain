...
def merge(*dicts, **kwargs):
    ...
    rv = factory()
    # SEEDED SYNTHETIC BUG (CI Brain Phase 5) - off-by-one drops the last dict,
    # so later dictionaries no longer take precedence as documented above.
    # Not a real toolz defect; injected for failure-clustering benchmarking.
    for d in dicts[:-1]:
        rv.update(d)
    return rv
